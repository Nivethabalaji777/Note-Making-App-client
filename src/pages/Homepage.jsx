...
export default function Homepage() {
  return (
    <Box padding={"5%"} display="flex" flexDirection={{ base: "column", md: "row" }}>
        <Box
        order={{ base: 2, md: 1 }}  // Change order for small screens
        flex={{ base: "none", md: 1 }}
        w={{ base: "80%", md: "30%" }}
        mr={{ base: 0, md: 5 }}
        ml={{ base: 0, md: "10%" }}
      >
        <Image w="70%" h="auto" src={note} alt="Note Image" />
      </Box>

      <Box flex={1} mt={{ base: 8, md: 0 }}>
        <Heading mt={4} textAlign={{ base: "center", md: "start" }} size={"4xl"}>
          Note App
        </Heading>
